...
//		prop.put("mail.transport.protocol", "smtp");
        ...
        //设置收件人
        msg.setRecipients(Message.RecipientType.TO,"530954924@qq.com");
...
//		msg.setRecipients(Message.RecipientType.BCC,"偷偷的发@163.com");
        ...
        //添加主题
        msg.setSubject("这是来自JAVA程序的邮件");

        //添加内容,第二个参数表示这是html的内容
        msg.setContent("<html><head ><meta charset='utf-8'>"
                + "</head><body>内容：为了保证您的帐户的安全，请验证您的电子邮件地址。<br>"
                + "<a href='http://192.168.20.244:8080/index.jsp '>点击此处来验证您的电子邮件地址。</a><br>" +
        "验证您的电子邮件地址让您能够：使用令牌，更改您的帐户凭据，" +
                "使用交易与市场确认，以及在您无法访问帐户或是忘记密码时，找回您的帐户。</body></html>",
...
//        msg.setFrom(new InternetAddress(sendAddr+"@163.com"));
//        // 设置收件人
//        msg.setRecipients(Message.RecipientType.TO, "1372892517@qq.com");
